  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Medication Schedules</h2>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {formData.frequency !== 'as-needed' && formData.scheduleTimes.length > 0 && (
                <div>
                  <label className="text-sm font-medium mb-2 block">Schedule Times</label>
            ...
            <Card key={med.id} className={!med.isActive ? 'opacity-50' : ''}>
              <CardContent className="flex items-center justify-between py-4">
                <div className="flex-1">
                  ...
                  {med.notes && (
                    <div className="text-sm text-gray-400 mt-1">{med.notes}</div>
                  )}
                </div>
